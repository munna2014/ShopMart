              ...
              <div className="mt-8 border-t border-gray-200 pt-6">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    disabled={editSaving}
                    className="px-6 py-3 bg-emerald-600 text-white rounded-lg font-semibold hover:bg-emerald-700 transition-colors disabled:opacity-60"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-3 border border-red-200 text-red-600 rounded-lg font-semibold hover:bg-red-50 transition-colors disabled:opacity-60"
                  >
