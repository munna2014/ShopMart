            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  required
                  className={`w-full px-5 py-4 bg-gradient-to-r from-emerald-50 via-teal-50 to-cyan-50 border-2 rounded-xl focus:ring-2 outline-none text-gray-900 placeholder-gray-500 transition-all duration-300 ${
                    errors?.name
